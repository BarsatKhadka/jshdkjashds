          ...
          <div className="flex-1 overflow-y-auto px-8 lg:px-12 py-16 lg:py-24">
            <div className="mb-8">
              ...
              <button 
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-mono text-sm tracking-wider transition-all flex items-center justify-center whitespace-nowrap shadow-lg shadow-emerald-500/20 font-bold"
              >
            ...
            {assignedModule && (
              <div className="mb-10">
                <div className="flex gap-3">
                  <button 
                    onClick={handleBeginTraining}
                    className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg font-mono text-sm tracking-wider transition-all shadow-lg shadow-emerald-500/20 font-bold"
                  >
                    START TRAINING
                  </button>
